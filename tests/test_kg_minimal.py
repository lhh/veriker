...
Test flow:
  ...
  7. Assert result.ok is False and RE_DERIVATION_MISMATCH in failures.
"""
...
def test_kg_minimal_tamper_triples_fails_verification(tmp_path: Path) -> None:
    ...
    with RE_DERIVATION_MISMATCH reported in the failures."""
    ...
    # kg_re_derivation.py emits [RE_DERIVATION_MISMATCH] on stderr on mismatch,

...
_OBSERVED_AT = "2026-06-09T00:00:00Z"
...
_CASES = [
    pytest.param(
        ...
        # control_rederivation cross-checks the attestation's observed_at
        # against this evidence's own captured_at (OBSERVED_AT_EVIDENCE_*
        # reason codes) — set equal to _OBSERVED_AT so these signature/verdict
        # tests aren't blocked by that unrelated binding.
        {"SummaryMap": {"AccountAccessKeysPresent": 0}, "captured_at": _OBSERVED_AT},

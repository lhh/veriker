...
def test_f4_dispatch_non_numeric_claimed_under_scalar_epsilon_is_rejected(
    ...
    scalar_epsilon comparator must produce a RE_DERIVATION_MISMATCH (comparator
    ...
    # The specific reason code is RE_DERIVATION_MISMATCH (comparator returned
    ...
    assert codes <= {"RE_DERIVATION_MISMATCH", "COMPARATOR_ERROR", "NON_FINITE_VALUE"}, (
        codes
    )

...
def test_re_derivation_invocation_check_returns_plugin_result(tmp_path: Path) -> None:
    ...
    The result is could-not-conclude, not OK: `ok is True` here until
    2026-08-31 was one of the assertions PINNING the absent-pack fail-open
    green while a sibling test in the same suite called it a defect.
    """

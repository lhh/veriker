...
Test flow:
  ...
  12. Re-run verifier — assert result.ok is False with RE_DERIVATION_MISMATCH.
...
# ---------------------------------------------------------------------------
# Tamper A: mutate load_N → RE_DERIVATION_MISMATCH
# ---------------------------------------------------------------------------
...
def test_pe_engineering_signoff_minimal_tamper_load_fails_rederivation(
    ...
    """Mutating load_N in inputs/analyses.json must cause RE_DERIVATION_MISMATCH

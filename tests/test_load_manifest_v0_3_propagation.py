...
def test_layer_a_plugin_fires_on_tamper_via_verifier_entry(
    ...
    # plugin's PluginResult.reason_code. Confirm it directly on the plugin so
    # the assertion does not depend on how the verifier surfaces it. (The outer
    # VerifyFailure.reason_code now carries the same code, propagated since
    # 2026-08-30; it used to be the generic 'plugin_failed' string.)

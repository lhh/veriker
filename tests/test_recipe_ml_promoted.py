...
shippable core registry (PRIMITIVES.md).
...
Surfaces:
  ...
  2. Tampered claimed value (increment one class index) -> RE_DERIVATION_MISMATCH.
  3. Tampered committed input (flip one feature value) -> RE_DERIVATION_MISMATCH.

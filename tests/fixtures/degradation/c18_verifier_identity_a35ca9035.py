...
def _extract_verifier_identity_block(manifest: object) -> dict | None:
    ...
    # short-circuit to None: callers read None as "legacy pre-C18 bundle, clean
    # PASS", so returning it here skips every C18 structural check on a
    # malformed block (fail-open). Fall through to the remaining lookups

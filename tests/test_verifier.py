...
def test_tampered_sum_invariant_returns_ok_false(
    ...
    # DECLARED-BUT-UNWIRED arm: BundleVerifier() registers no plugins, so no
    # check ran and the generic code is the correct one. This arm deliberately
    # stayed generic when the ran-and-failed arm began propagating the plugin's
    # own code (2026-08-30) -- a specific code here would be a claim about a

    ...
    def check(self, bundle_dir: Path, manifest) -> PluginResult:
        ...
        if result.returncode == 0:
            return PluginResult(
                ...
                # _step_rederivation_surface_guard. Without this,
                # the mesh pilot (which this check genuinely re-derives)
                # was measured returning exit 2 under --require-rederivation.
                verified_rederivations=frozenset({"sensor_re_derivation"}),
            )

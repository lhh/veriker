...
the shippable core registry (PRIMITIVES.md, shape `real-compiler build digest`).
...
class BuildRealCompilerRecompute:
    ...
    primitive_shape: str = "real-compiler build digest"
    ...
    primitive_scope_limits: tuple[str, ...] = (
        ...
        "Reproducibility is CPython-bytecode reproducibility: the same source "
        "under a different CPython version produces a different digest, which "
        "the certificate reads as a mismatch.",
    )

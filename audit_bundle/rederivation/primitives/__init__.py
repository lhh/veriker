...
Promoted recompute primitives (PRIMITIVES.md; comparator in parens):
  ...
  - fea_witness_certificate    -> rational_sqrt_band (the FEA pilot; witness+certificate — checks a committed displacement field, never solves)
...
deliberate phasing by computation shape, not a silent cap. Every primitive
listed above is described in PRIMITIVES.md, with its declared contract, its
contract revision, its tier and its scope limits.

...
def build(out_dir: Path) -> None:
    ...
    content = BundleContent(
        ...
        # Claim-field coverage: the rendered MP4 is the claim, a whole-file
        # (opaque) declaration; HyperFramesReDerivationCheck reports it covered
        # only after the pack re-renders and compares.
        extra_manifest_fields={
            "claimset": {"opaque_claim_files": {"output": "payload/output.mp4"}}
        },
    )

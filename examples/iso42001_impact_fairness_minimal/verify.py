"""verify.py — iso42001_impact_fairness_minimal domain pilot bundle verifier.

the audit-bundle contract §C5 (auditor independence). Registers the
Iso42001DisparateImpactRecompute primitive and verifies a single-output
spec-pinned bundle. The auditor's SpecAnchor is derived from the COMMITTED spec
file, NOT the bundle's copy.

Usage:
    python examples/iso42001_impact_fairness_minimal/verify.py --bundle-dir <path>
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="iso42001_impact_fairness_minimal audit bundle verifier (§C5)"
    )

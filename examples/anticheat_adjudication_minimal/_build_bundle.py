...
def _compute_attestation_hmac(
    ...
    (an automated detector-version sign-off vs. a human moderator sign-off — the
    responsible-actor binding the pilot exists to demonstrate) cannot be forged
    independently of the rest of the attestation; the field has no other copy
    anywhere in the bundle to cross-check against."""
    msg = (

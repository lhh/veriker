...
# 3. Or build in-place and verify with the pilot's own anchored wrapper
python examples/chat_log_redaction_minimal/_build_bundle.py  # in-place
python examples/chat_log_redaction_minimal/verify.py --bundle-dir examples/chat_log_redaction_minimal/

...
verify.py). The top-level verify CLI instead auto-detects re_derive/*_pack.py inside the
...
class HealthcareDiagnosisReDerivationCheck:
    ...
    def check(self, bundle_dir: Path, manifest) -> PluginResult:
        ...
        # contained — same convention as the top-level verify CLI's auto-detected

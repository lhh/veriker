...
def build(out_dir: Path) -> None:
    ...
    content = BundleContent(
        ...
        # Claim-field coverage: the aggregated CSV is the claim, a whole-file
        # (opaque) declaration; TabularReDerivationCheck reports it covered only
        # after the pack re-derives the aggregate and byte-compares the file.
        extra_manifest_fields={
            "claimset": {"opaque_claim_files": {"result": "payload/result.csv"}}
        },
    )

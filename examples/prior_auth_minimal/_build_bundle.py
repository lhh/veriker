...
def _compute_attestation_hmac(
    ...
    provider_role). Mirrors prior_auth_re_derivation.py — provider_role is bound so
    WHO signed off (medical_director vs. attending_physician — CO Reg 10-1-1 §5.A.5)
    cannot be forged independently of the rest of the attestation."""

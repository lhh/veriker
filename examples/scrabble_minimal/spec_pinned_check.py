...
def _ruling_from_producer_payload(out_dir: Path) -> dict:
    ...
    only prove f(x) == f(x) (the failure mode the promotion criteria forbid — PRIMITIVES.md). The producer
...
def build_spec_pinned(
    ...
    *,
    ...
    #     (independent of the verifier's recompute — anti-tautology; PRIMITIVES.md, promotion criteria). ---
